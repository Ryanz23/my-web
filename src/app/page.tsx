        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-12 max-w-3xl">
            <p className="text-lg md:text-xl text-gray-300 leading-relaxed font-light">
              Undergraduate <span className="text-blue-400 font-medium">Informatics Engineering</span> Student, 
              Front-End & Back-End Developer Cohort at <span className="text-purple-400 font-medium">Coding Camp by DBS Foundation</span>, 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
            <div className="group p-6 bg-white/5 backdrop-blur-sm border border-gray-700/50 rounded-2xl hover:bg-white/10 transition-all duration-300 hover:scale-105">
              ...
              <p className="text-gray-400 text-sm">Informatics Engineering</p>
            </div>
            ...
            <div className="group p-6 bg-white/5 backdrop-blur-sm border border-gray-700/50 rounded-2xl hover:bg-white/10 transition-all duration-300 hover:scale-105">
              ...
              <p className="text-gray-400 text-sm">Cohort at DBS Coding Camp 2025</p>
            </div>
