      ...
      <main className="container mx-auto px-6 py-24 relative z-10">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="prose prose-lg max-w-3xl text-gray-300 space-y-4">
            <p>
              I am a Front-End Developer with a passion for creating responsive and user-friendly web applications. Currently, I am learning{" "}
              <a
            ...
            <p>
              My journey in web development started with a keen interest in building interactive user interfaces. I enjoy working with modern technologies and frameworks to deliver high-quality web experiences. I&apos;m also expanding my skills into back-end development, exploring server-side technologies to become a Full Stack Developer.
            </p>
          </div>
          ...
          {/* Skills List */}
          <div className="flex flex-wrap justify-start max-w-none gap-3 mt-4">
            {/* Skill Card Template */}
            {[
              ...
              { src: tailwindImage, alt: "Tailwind CSS", label: "TAILWIND CSS" },
